export interface Video {
  id: string;
  title: string;
  category: 'Documentaries' | 'Corporate & Brand' | 'Collaborations' | 'Shortform';
  description: string;
  youtubeUrl: string;
  thumbnail: string;
  role: string;
...
export const videos: Video[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://ik.imagekit.io/orductive/photography/Hub%20Page%20images/Cover.jpg',
  ...
  },
  {
    ...
    role: 'Behind the Scene Photos, Thumbnail Photo',
  },
  {
    id: 'collab-2',
